...
local function draw_controls1()
  ...
  screen.move(94, 20)
  screen.text_right(params:get(silos.enc_choices[1]))
  screen.move(30, 30)
  screen.text(silos.enc_choices[2])
  screen.move(94, 30)
  screen.text_right(params:get(silos.enc_choices[2]))
  screen.move(30, 40)
...
local function draw_controls2()
  ...
  screen.move(94, 20)
  screen.text_right(params:get(silos.arc_choices[1]))
  screen.move(30, 30)
  screen.text(silos.arc_choices[2])
  screen.move(94, 30)
  screen.text_right(params:get(silos.arc_choices[2]))
  screen.move(30, 40)
  screen.text(silos.arc_choices[3])
  screen.move(94, 40)
  screen.text_right(params:get(silos.arc_choices[3]))
  screen.move(30, 50)
  screen.text(silos.arc_choices[4])
  screen.move(94, 50)
  screen.text_right(params:get(silos.arc_choices[4]))
end
...
local function draw_controls3()
  ...
  screen.move(114, 20)
  screen.text_right(params:get(silos.gridx_choices[1]))
  screen.move(40, 30)
  screen.text("y - " .. silos.gridy_choices[1])
  screen.move(114, 30)
  screen.text_right(params:get(silos.gridy_choices[1]))
  screen.move(10, 40)
  screen.text("grid 2:")
  screen.move(40, 40)
  screen.text("x - " .. silos.gridx_choices[2])
  screen.move(114, 40)
  screen.text_right(params:get(silos.gridx_choices[2]))
  screen.move(40, 50)
  screen.text("y - " .. silos.gridy_choices[2])
  screen.move(114, 50)
  screen.text_right(params:get(silos.gridy_choices[2]))
